...
export function AppSidebar() {
  ...
  const isActive = (route: string) => {
    ...
    if (route === "/overview" && (location.pathname === "/overview" || location.pathname === "/client-mau" || location.pathname === "/experiments" || location.pathname === "/data-export" || location.pathname === "/service-requests")) {
      return true;
    }

    // Check if we're on a Diagnostics route
    if (route === "/diagnostics" && (location.pathname === "/diagnostics" || location.pathname === "/client-connections" || location.pathname === "/server-mau" || location.pathname === "/peak-server-connections")) {
      return true;
    }
